...
file2 = "clinical_features.csv"
f = open(file2)
csv_f = csv.reader(f)
dataset = pd.read_csv(file2, low_memory=False, encoding='ascii')
...
# imp.fit(arrayClin)
# arrayClin = imp.transform(arrayClin)
